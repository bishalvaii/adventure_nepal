...
const ProductCard = ({ product }) => (
  ...
  <Card sx={{ maxWidth: 300, margin: '1rem', borderRadius: '12px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)', position: 'relative' }}>
    <div style={{ margin: 'auto', marginTop: '1rem', borderRadius: '12px', position: 'relative' }}>
      ...
      <Image  src={product.image.url} alt={product.name} width={product.image.width} height={product.image.height} />      <CardContent style={{ position: 'absolute', bottom: '0', left: '0', width: '100%', backgroundColor: 'purple', color: 'white', padding: '8px' }}>
